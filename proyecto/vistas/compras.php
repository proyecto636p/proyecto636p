...
<!-- FIN DEL HEADER - LIBRERIAS -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Realizar Pedidos de Consumibles a Proveedores
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
         ...
         <div class="btn-group text-center">
          <a href="consultar_compras.php" class="btn btn-primary btn-lg" ><i class="fa fa-search" aria-hidden="true"></i> Consultar PEdidos</a>
         </div>
