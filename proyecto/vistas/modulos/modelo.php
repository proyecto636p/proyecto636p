      ...
      <div class="box-body">
       ...
       <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
        ...
        <?php
          ...
          $modelos = ControladorModelo::ctrMostrarModelos($item, $valor);
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
        ...
        <?php
          ...
          $crearModelo = new ControladorModelo();
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <?php
          ...
          $editarModelo = new ControladorModelo();
...
<?php
  ...
  $borrarModelos = new ControladorModelo();
