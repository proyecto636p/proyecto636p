    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" id="nuevoTipo" name="nuevoTipo" required>
                  ...
                  $categorias = ControladorTiposC::ctrMostrarTipos($item, $valor);
        ...
        <?php
          ...
          $crearMarca = new ControladorMarcasC();
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <?php
          ...
          $editarMarca = new ControladorMarcasC();
...
<?php
  ...
  $borrarMarca = new ControladorMarcasC();
